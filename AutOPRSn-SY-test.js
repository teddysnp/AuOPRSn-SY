...
const missionlist=[["职工文体广场","北一路万达","true","编辑","","2024-09-09"],["摆烂的天使","北一路万达","true","新增","","2024-09-09"],["丛林里的梅花鹿","北一路万达","false","编辑","","2024-09-09"]];
...
//https://wayfarer.nianticlabs.com/api/v1/vault/home
  if (url == "/api/v1/vault/home" || url =="https://wayfarer.nianticlabs.com/api/v1/vault/home") {
      var resp = autoPR.xhrPromise("GET","https://wayfarer.nianticlabs.com/api/v1/vault/properties");
      console.log("XMLHttpRequest.home.xhrPromids.properties:");
      console.log(resp);
      console.log("XMLHttpRequest:home:"+url);
  }
...
//       if(autoPR.username){
       ...
       $(".showcase-gallery").replaceWith("<div><font size=5>任务  ||  </font><input type='checkbox' id='cbxmission' onclick=autoPR.saveMission()>任务完成自动暂停(开发中)</input></div><div id='missionPortal1'></div><br><div><font size=5>池中已审</font></div><div id='privatePortal1'></div><br><div><font size=5>池外已审</font></div><div id='privatePortal2'></div>");
       if(cbxmiss){
         if(cbxmiss=="true"){
